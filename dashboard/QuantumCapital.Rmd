...
```{r input_layout}
  ...
  positions <- eventReactive(input$go, {
    ...
    test.data <- baseline[Date >= start.date()]
    test.data[, index := .I]
  ...
  commodity.return <- eventReactive(input$go, {
    ...
    period <- commodity()[Date >= start.date()]
  ...
  benchmark.return <- eventReactive(input$go, {
    ...
    period <- benchmark()[date >= start.date()]
  ...
  strategy.garch <- eventReactive(input$go, {
    ...
    test.data <- baseline[Date >= start.date()][, .(Date, return)]
...
renderPlotly({
  ...
  data <- commodity()[Date >= start.date()]
